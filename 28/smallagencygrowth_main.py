...
url = 'https://www.smallagencygrowth.com/chats-with-chip/'
...
driver.get(url)
time.sleep(4)
podcast=driver.find_element_by_xpath('//div[@class="elementor-posts-container elementor-posts elementor-posts--skin-classic elementor-grid elementor-has-item-ratio"]')
...
try:
    while True:
        time.sleep(4)
        next_page=driver.find_element_by_xpath('//a[@class="page-numbers next"]')
...
for za in url_list:
    ...
    try:
        ...
        try:
            ...
            print('clicked')
            time.sleep(5)
            transcript = driver.find_element_by_xpath('//div[@class="kt-accordion-panel kt-accordion-panel-active"]')
        ...
        time.sleep(4)
        try:
            audio_path = driver.find_element_by_xpath('//a[@class="powerpress_link_d"]')
