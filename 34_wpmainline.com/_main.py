...
url = 'https://wpmainline.com/podcast/'
action = ActionChains(driver)
url_list = []
base_dir = './wpmainline.com'
count=1
...
driver.get(url)
time.sleep(4)
podcast=driver.find_element_by_xpath('//*[@id="main"]')
...
try:
    while True:
        older_podcast = driver.find_element_by_xpath('//a[@class="next page-numbers"]')
...
for za in url_list:
    ...
    try:
        ...
        title = title1.text
        print(title)
        driver.find_element_by_xpath('//summary[@class="lightweight-accordion-title"]').click()
        time.sleep(5)
        print('clicked')
        ...
        time.sleep(4)
        try:
            audio_path = driver.find_element_by_xpath('//a[@class="podcast-meta-download"]')
