...
for i in url_list:
    ...
    try:
        ...
        try:
            ...
            read_more=driver.find_element_by_xpath('//div[@class="collapseomatic colomat-visited"]')
            read_more.click()
            time.sleep(4)
        except:
            print('00000000')
            pass
        # transcript = driver.find_element_by_xpath('//div[@class="vc_row wpb_row vc_inner vc_row-fluid"]')
