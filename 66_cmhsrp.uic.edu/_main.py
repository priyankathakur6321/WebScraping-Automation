...
url = 'http://www.cmhsrp.uic.edu/health/podcasts.asp'
action = ActionChains(driver)
url_list = []
base_dir = './cmhsrp.uic.edu'
count=1
...
while ir!=20:
    ...
    audio_path = ''
    audio = ''
    base_xpath='//*[@id="podcastWrapper"]/div['
    post_date = ''
    file_name = ''
    try:

        time.sleep(5)
        title1 = driver.find_element_by_xpath(base_xpath+str(ir)+']/div[2]/h3')
        title = title1.text
        print(title)
        ...
        transcript_link=driver.find_element_by_xpath(base_xpath+str(ir)+']/div[2]/a')
        transcript_link = transcript_link.get_attribute('href')
        print(transcript_link,'link for transcript')
        time.sleep(8)
        ...
        try:
            ...
            # driver.get(iframe)
            # time.sleep(4)
            audio_lnk=driver.find_element_by_xpath(base_xpath+str(ir)+']/div[2]/ul/li/a')
            ...
            time.sleep(8)
            transcript=driver.find_element_by_xpath('//*[@id="content"]')
